class Scrapper::Theater < ::Model
  ...
  def execute
    ...
    theater = ::Theater.new(name: theater_name, location: theater_location, movies: [])
  ...
  def exctact_movie(row)
    ...
    ::Movie.new(image_url: img, title: title, actors: actors, plot: plot, times: times)
  end
